...
class MaskRCNN():
	...
	# Callbacks
        ...
        model_history = self.keras_model.fit_generator(
            train_generator,
            ...
            max_queue_size=100,
            workers=1,	                 # workers=workers     keras.utils.Sequence()
            use_multiprocessing=False,   # (True--> False) modified by Hubert  --> to solve the issue of getting stuck in the first epoch
        )
        
        print("-"*50)
        print("Loss values: ",history.losses)
        print("-"*50)
