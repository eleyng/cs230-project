...
DATA_DIR = os.path.join('/Volumes/Hubert_drive/kaggle_dataset/', 'input')
# DATA_DIR = os.path.join('..', 'input')
# '/Volumes/Hubert_drive/kaggle_dataset/input/train_color/'
