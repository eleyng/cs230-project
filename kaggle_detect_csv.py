...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "logs/kaggle20180608T0904/mask_rcnn_kaggle_0016.h5")     # ---> the new run with LR = 0.001     (model 2) (Hubert 3:04am 6/9)
#COCO_MODEL_PATH = os.path.join(ROOT_DIR, "logs/kaggle20180608T0905/mask_rcnn_kaggle_0016.h5")     # ---> the new run with LR = 0.005     (model 2) (Hubert 3:04am 6/9)
#COCO_MODEL_PATH = os.path.join(ROOT_DIR, "mask_rcnn_kaggle_0013.h5")
