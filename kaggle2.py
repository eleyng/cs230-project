...
class KaggleConfig(Config):
    ...
    IMAGES_PER_GPU = 1  # 2 modified by Hubert
    ...
    BACKBONE = "resnet50"   # Modified by Hubert (originally this line was turned off)
...
#        self.add_class("kaggle", 0, "others")
	...
	# the folder of train_color contains 15k images 
        ...
        TRAIN_IMAGE_IDS, VAL_IMAGE_IDS = train_test_split(os.listdir(dataset_dir), test_size=0.1, random_state=0) 
